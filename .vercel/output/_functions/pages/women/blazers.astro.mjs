...
const $$Blazers = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "Women Blazers \u2014 Maison MKY", "fullWidth": true }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="min-h-screen bg-white">  ${renderComponent($$result2, "CatalogTopBar", CatalogTopBar, { "client:load": true, "categoryTitle": "Blazers", "client:component-hydration": "load", "client:component-path": "/Users/ehabriaz/Desktop/\u03B5/mky/apps/storefront/src/components/CatalogTopBar.tsx", "client:component-export": "default" })}  ${renderComponent($$result2, "CategoryIconNav", CategoryIconNav, { "client:load": true, "categories": womenCategories, "currentCategory": "Blazers", "client:component-hydration": "load", "client:component-path": "/Users/ehabriaz/Desktop/\u03B5/mky/apps/storefront/src/components/CategoryIconNav.tsx", "client:component-export": "default" })}  ${renderComponent($$result2, "CatalogHero", CatalogHero, { "client:load": true, "image": "/images/explore-women-blazers.png", "alt": "Women's Blazers Collection", "client:component-hydration": "load", "client:component-path": "/Users/ehabriaz/Desktop/\u03B5/mky/apps/storefront/src/components/CatalogHero.tsx", "client:component-export": "default" })}  <div class="w-full"> ${renderComponent($$result2, "ProductGrid", ProductGrid, { "client:load": true, "gender": "women", "collection": "blazers", "client:component-hydration": "load", "client:component-path": "/Users/ehabriaz/Desktop/\u03B5/mky/apps/storefront/src/components/ProductGrid.tsx", "client:component-export": "default" })} </div> </div> ` })} `;
}, "/Users/ehabriaz/Desktop/\u03B5/mky/apps/storefront/src/pages/women/blazers.astro", void 0);

const $$file = "/Users/ehabriaz/Desktop/ε/mky/apps/storefront/src/pages/women/blazers.astro";
const $$url = "/women/blazers";
